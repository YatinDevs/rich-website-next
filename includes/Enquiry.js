      ...
      <div className=" py-10  sm:py-10 lg:py-10" >
        <div className='px-4 mx-auto max-w-7xl sm:px-6 lg:px-8'>
          <div className="hero  ">
            ...
            <div className="card bg-base-100 w-full max-w-md shrink-0 shadow-2xl" data-aos="fade-up" data-aos-delay="100">
...
{danger &&     <div className='px-10 my-3'>
  ...
  className="textarea textarea-bordered textarea-sm w-full max-w-md"  {...register("message")} ></textarea>
              ...
              <div className="text-center lg:text-left" data-aos="fade-up" data-aos-delay="100">
                <h1 className="text-6xl font-bold">Have a Question or need any assistance?</h1>
                <h1 className="text-6xl font-bold text-blue-900">Reach Out to us</h1>
                <p className="py-6">
